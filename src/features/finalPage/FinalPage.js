        ...
        <PhoneContext.Provider value={phone}>
          ...
          <CartTotalContext.Provider value={cartTotal}>
            ...
            <Stack direction={{xs:'column', lg:'row'}} justifyContent='center' spacing={2} >
              <Stack direction={{xs:'column', md:'row', lg:'column'}} spacing={2} sx={{width:{xs:'100%', lg:'40%'}, height:{md:'100%', lg:'30%'}}}>
                ...
                <InputForm setName={setName} setAdress={setAdress} setEmail={setEmail} setPhone={setPhone} setCurrier={setCurrier} sx={{height:{md:'100%', lg:'70%'}}}/>
              </Stack>
